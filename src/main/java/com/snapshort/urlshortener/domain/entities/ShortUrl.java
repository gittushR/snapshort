package com.snapshort.urlshortener.domain.entities;
...
public class ShortUrl {
    ...
    public com.snapshort.urlshortener.domain.entities.User getCreatedBy() {
        return createdBy;
    }

    public void setCreatedBy(com.snapshort.urlshortener.domain.entities.User createdBy) {
